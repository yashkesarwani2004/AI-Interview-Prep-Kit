...
* 🧬 **Multi-Stage Generation Pipeline**: Avoids single monolithic prompts by separating extraction into specialized steps (JD Extraction → Company Brief → 4 Question Categories → Flashcards).
...
* Priority scoring (`100 × isMust + 10 × difficulty`) ensuring harder/higher-priority items land on earlier days.
...
```bash
git clone https://github.com/yashkesarwani2004/AI-Interview-Prep-Kit.git
